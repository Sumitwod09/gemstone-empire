    ...
    <div>
      ...
      <div className="mb-4 flex flex-col sm:flex-row gap-2">
        <input
          ...
          className="border border-gray-200 rounded-lg px-3 py-2 text-sm w-full sm:w-80 outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-100 transition-all bg-white"
        />
        <select
          ...
          <table className="w-full text-sm min-w-[600px]">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="px-4 py-2.5 text-left text-[10px] text-gray-400 font-bold uppercase tracking-wider">Price Range</th>
